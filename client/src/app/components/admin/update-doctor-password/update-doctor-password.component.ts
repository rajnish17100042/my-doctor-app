...
@Component({
  selector: 'app-update-doctor-password',
  templateUrl: './update-doctor-password.component.html',
  styleUrls: ['./update-doctor-password.component.css']
})
export class UpdateDoctorPasswordComponent implements OnInit {
public password={
   currentPassword:'',
   newPassword:'',
   confirmNewPassword:'',
